...
public class Steps {
    ...
    @When("^As quantidades de pessoas \"([^\"]*)\", \"([^\"]*)\", \"([^\"]*)\"$")
    public void as_quantidades_de_pessoas(String arg1, String arg2, String arg3) throws Throwable {
    ...
    @When("^Tendo os valores \"([^\"]*)\", \"([^\"]*)\", \"([^\"]*)\"$")
    public void tendo_os_valores(String arg1, String arg2, String arg3) throws Throwable {
    ...
    public void eh_calculada_e_normalizada_a_temperatura_da_sala() throws Throwable {
        assertEquals(28, arCondicionado.TEMPERATURA_ALERT);
    }
